...
export default function ComplaintsPage() {
  return (
    <LegalPage title="Complaints & ADR" updated="10 July 2026">
      ...
      <p>
        If it isn&apos;t resolved, put your complaint in writing within 28 days
        of returning. Email {site.contact.email}
        {has(site.legal.registeredAddress) ? `, or write to ${site.legal.registeredAddress}` : ""}.
        Include your booking reference and what you&apos;d like to happen.
        I&apos;ll acknowledge within a few working days and aim to resolve it
        promptly.
      </p>
      ...
      <p>
        ...
        ABTA&apos;s scheme provides low-cost, independent resolution — details at
        abta.com. Other schemes may apply depending on your booking; I&apos;ll
        point you to the right one.
      </p>

      <h2>Financial protection claims</h2>
      <p>
        If a supplier fails, the financial protection that applies to your
        booking (ATOL and/or ABTA, as shown on your booking confirmation)
        explains how to claim. I&apos;ll help you through it.
      </p>
    </LegalPage>
  );
}
